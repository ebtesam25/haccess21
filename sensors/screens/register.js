...
export default function Register({}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{fontFamily:'A', fontSize:65, color:'#1a2a94', textAlign:'center'}} onPress={()=>navigation.navigate('Login')}>Register</Text>
              ...
              <View style={{marginTop:'5%', backgroundColor:'#FFF', alignSelf:'center', width:'100%'}}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Login')}><Text style={{fontFamily:'A', fontSize:20, textAlign:'center', alignSelf:'center', backgroundColor:'#1a2a94', color:'#FFF', width:'70%', paddingVertical:'4.5%', borderRadius:10, elevation:0, marginTop:'15%'}}>
                    REGISTER
                 ...
                 <TouchableOpacity><Text style={{fontFamily:'A', fontSize:17, textAlign:'center', color:'#1a2a94'}} onPress={()=>navigation.navigate('Login')}> here</Text></TouchableOpacity>
                </View>
